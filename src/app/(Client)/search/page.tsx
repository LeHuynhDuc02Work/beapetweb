    ...
    return (
        <div className="scrumb py-2 bg-slate-100">
            <p className="px-5 font-medium">
                <Link className="hover:text-blue-300" href="/">Home</Link> / Search
            </p>
        </div>
    )
}
        ...
        <div className="search-product">
            ...
            <div className="search-product__header flex justify-between m-4">
                <div className="search-product__title">
                    <h1 className="text-3xl font-bold">Kết quả tìm kiếm cho từ khóa abc</h1>
                </div>
                <div className="search-product__filter">
                    <span className="font-bold">Filter:</span> {DropdownFilter()}
                </div>
            </div>
            <div className="search-product__container container w-full flex justify-center flex-wrap">
                {Product()}
                {Product()}
                {Product()}
                {Product()}
